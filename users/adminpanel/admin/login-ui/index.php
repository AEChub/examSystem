		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form method="post" id="adminLoginFrm" class="login100-form validate-form">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Заполните поле логина">
						<span class="label-input100">Логин</span>
						<input class="input100" type="text" name="username" placeholder="Ввведите логин">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Заполните поле пароля">
